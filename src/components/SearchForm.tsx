...
export const SearchForm: FC = () => {
  ...
  const mostResarchs : MostResarchs = ["Chicken", "Bread", "Meat", "Breakfast", "Toast", "Tea"]
      ...
      <div className="input-container">
        ...
        <div className="input-button" >
            {mostResarchs.map((res, i) => (
                <Button id="button" key={i} variant="contained" size="small" onClick={()=> setQuery(res)} >{res}</Button>
            ) )}
        </div>
    </React.Fragment>
  );
